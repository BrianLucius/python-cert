...
print('.' * 20)
Demo.class_var="I've changed the class variable!"
print('contents of d2:', d2.__dict__)
print("New contents of d2 class variable:",d2.class_var)
print("Old contents of d1 instance variable:",d1.class_var)